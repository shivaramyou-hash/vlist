...
const ViewVoter = () => {
  ...
  const [countToShow] = useState(300);
    ...
    <>
      <Card>
        <Grid container>
          ...
          >
            <PaginationTable
              colsData={viewcotercols}
              rowsData={votersList}
              countToShow={countToShow}

              // clickable={clientClickable}
              //   clickable={appicantClickable}
              //   dates={["issueDate", "validTill", "returnedOn"]}
            />
          </Grid>
        </Grid>
      </Card>
